...
// Only house1.glb exists in public/models. The preloads for house2c.glb and house3c.glb
// were requesting files that are not in the repository, producing two 404s on every page
// load - this module is reached from App's route table, so the preloads ran app-wide.
