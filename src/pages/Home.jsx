...
function Home() {
  ...
  // Featured listings come from the catalogue API, so the home page, the listings grid and
  // the detail page can no longer disagree about what a given listing is.
  const featured = useFeaturedProperties(3);
  ...
  return (
    <div className="space-y-16">
      ...
      <section className="container">
        ...
        {!featured.error && featured.isLoading && <SkeletonGrid count={3} />}

        {!featured.error && !featured.isLoading && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {(featured.data || []).map((property, index) => (
